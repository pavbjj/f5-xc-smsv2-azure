prefix                  = "prod-f5-xc"      # Prefix for all objects in the project
description             = "Managed by ADO"  # description of all XC resources
instance_type           = "Standard_D8s_v4" # SMALL: Standard_D4s_v4	MEDIUM: Standard_D8s_v4	LARGE: Standard_D16s_v4
